...
class BlockMetadata(object):
    ...
    def get_bitout(self, field_path):
        return self.get_indexes(field_path)[2]

    def get_posout(self, field_path):
        return self.get_indexes(field_path)[2]
    ...
    def table_addr_reg_addr_from_field(self, field_path):
        return self.reg_addr_from_field(field_path, -2)

    def table_length_reg_addr_from_field(self, field_path):
        return self.reg_addr_from_field(field_path, -1)
